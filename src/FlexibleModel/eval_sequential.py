# eval_sequential.py
"""
Evaluation script for Experiment 3: Sequential Learning
Loads trained sequential model and evaluates on both toxicity and emotion test sets.
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate Sequential Experiment')
    parser.add_argument("--model_path", type=str, default="models/sequential_unbalanced.pt",
    ...
    try:
        ...
        tox_metrics = compute_metrics(
            ...
            task_name="Sequential - Toxicity Classification"
        )
        ...
        emo_metrics = compute_metrics(
            ...
            task_name="Sequential - Emotion Classification"
        )
